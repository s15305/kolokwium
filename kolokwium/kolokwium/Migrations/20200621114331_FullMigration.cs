        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdMusicianLabel = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Album", x => x.IdAlbum);
                    table.ForeignKey(
                        name: "FK_Album_MusicLabel_IdMusicianLabel",
                        column: x => x.IdMusicianLabel,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Album_IdMusicianLabel",
                table: "Album",
                column: "IdMusicianLabel");
